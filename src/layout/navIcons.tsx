...
export const WaitingListIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      width='24'
      height='24'
...
export const SettingIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      className={className}
    >
      <g clipPath='url(#clip0_2630_14216)'>
        <path
...
export const AppointmentIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='24'
...
export const DisputeIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='24'
